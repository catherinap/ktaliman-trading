...
This panel flags assets sitting in the extreme zones — a COT Index at or above ninety (crowded long) or at or below ten (crowded short). The label shows how many assets are currently at an extreme.
...
Сетап потрійного підтвердження сам по собі не є торговим сигналом. Це найякісніший фільтр, який може згенерувати платформа. Підтвердіть момент входу за допомогою цінової дії або технічного аналізу та керуйте ризиком так само, як і з будь-яким іншим сетапом.`
    ...
    // ── 8. MARKET SENTIMENT ─────────────────────────────────────────────────────
    {
        ...
        summary: {
            en: "Three composite mood metrics derived from COT positioning and macro data — Fear & Greed, Velocity, and Stagnation. They describe the emotional temperature and the speed of the market, not the direction of any single asset.",
            uk: "Три зведені метрики настрою, виведені з позиціонування COT та макро-даних — Страх і Жадібність, Швидкість та Стагнація. Вони описують емоційну температуру та швидкість ринку, а не напрямок окремого активу."
        },
        blocks: [
            {
                title: {
                ...
                content: {
                    en: `The Fear & Greed gauge is a single number from zero to one hundred that summarizes the overall emotional state of the market. Zero means extreme fear — panic, everyone selling, defensive positioning everywhere. One hundred means extreme greed — euphoria, everyone crowded into longs, complacency at its peak.
...
The score blends four ingredients. The largest weight, forty-five percent, comes from amplified positioning — the average COT Index across all assets, amplified by crowding. When most assets are positioned long and the dispersion between them is low (everyone agrees), this pushes toward greed. When most are positioned short with low dispersion, it pushes toward fear.

Thirty percent comes from VIX, inverted. A low VIX (calm markets) reads as greed; a high VIX (fearful markets) reads as fear. A VIX of ten maps toward greed, a VIX of forty maps toward fear.
...
The final ten percent comes from raw positioning level without amplification, as a stabilizer.
...
[[BOLD]]Practical example:[[/]] Velocity is at sixty-five, Stagnation is at twelve, and the slider leans clearly right. The market is actively repositioning. You find a long signal on copper with a Priority Score of seventy-eight. The high-velocity backdrop supports acting on it — institutional money is in motion and momentum is on your side. Now imagine the opposite: Stagnation is at fifty-five, Velocity is at twenty, the slider leans left. The same copper signal exists, but the frozen backdrop suggests it may stall. Reduce size and wait for a catalyst, or for velocity to pick up, before committing fully.`,
